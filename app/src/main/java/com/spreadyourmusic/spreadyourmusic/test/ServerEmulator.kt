...
object ServerEmulator {
    ...
    init {
        ...
        val cancion19 = Song(album = album6, id = 19, name = "Gotti", locationUri = "http://storage.googleapis.com/automotive-media/Drop_and_Roll.mp3", lyricsPath = null, genere = null)
        val cancion20 = Song(album = album7, id = 20, name = "Animal", locationUri = "http://storage.googleapis.com/automotive-media/Drop_and_Roll.mp3", lyricsPath = null, genere = null)
