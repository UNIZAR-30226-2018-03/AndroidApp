 ...
 * On 8/03/18.
 */
class RecomendationsVerticalRecyclerViewAdapter(val context: Context?) : RecyclerView.Adapter<GeneralRecyclerViewViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
        ...
        val itemView = when (viewType) {
            VIEW_TYPE_SONG ->
                LayoutInflater.from(parent.context).inflate(R.layout.listitem_song_horizontal, parent, false)

            VIEW_TYPE_USER ->
                LayoutInflater.from(parent.context).inflate(R.layout.listitem_user_horizontal, parent, false)

            VIEW_TYPE_PLAYLIST ->
                LayoutInflater.from(parent.context).inflate(R.layout.listitem_playlist_horizontal, parent, false)
